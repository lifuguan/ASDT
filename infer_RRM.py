...
if __name__ == '__main__':
    ...
    parser.add_argument("--weights", default='./output/model_weights/exp1/RRM_150_6_18000.pth', type=str)
    ...
    parser.add_argument("--out_la_crf", default='./output/result/crf/0.5_0.5/rrm_18000_max_vis', type=str)
    ...
    for i in img_list:
        ...
        img_temp = cv2.cvtColor(img_temp, cv2.COLOR_BGR2RGB).astype(float)
